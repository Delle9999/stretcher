...
Config.Language = {
	...
	open_menu = 'Tryk ~b~E',
	do_action = 'Tryk ~INPUT_CONTEXT~ for at bruge stretcher',
	take_bed = "Tryk ~INPUT_CONTEXT~ for at tage stretcher",
	release_bed = "Tryk ~INPUT_SPECIAL_ABILITY_SECONDARY~ for at ligge stretcher",
	in_vehicle_bed = "Tryk ~INPUT_CONTEXT~ for at opbevare",
	out_vehicle_bed = "Tryk ~INPUT_CONTEXT~ for at modtage stretcher",
